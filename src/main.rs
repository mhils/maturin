...
#[cfg(feature = "upload")]
use crate::commands::upload::{upload_ui, PublishOpt};
use crate::commands::{
    new_project::{init_project, new_project, GenerateProjectOptions},
    pep517::{pep517, Pep517Command},
};
use anyhow::{bail, Context, Result};
use cargo_metadata::MetadataCommand;
use fs_err as fs;
use maturin::{
    develop, source_distribution, BridgeModel, BuildOptions, CargoToml, Metadata21, PyProjectToml,
